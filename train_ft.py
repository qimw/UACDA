...
from trainer_ms_variance_simple import AD_Trainer
from utils.loss import CrossEntropy2d
from utils.tool import adjust_learning_rate, adjust_learning_rate_D, Timer 
from dataset.dark_zurich_pseudo_dataset import DarkZurichPseudoDataSet
...
def main():
    ...
    targetloader = data.DataLoader(DarkZurichPseudoDataSet(args.data_dir_target, args.data_list_target,
                                                     max_iters=args.num_steps * args.iter_size * args.batch_size,
                                                     resize_size=args.input_size,
                                                     crop_size=args.crop_size,
                                                     scale=False, 
    ...
    for i_iter in range(args.num_steps):
        ...
        eta = (current_time - start_time) / (i_iter + 1) * (args.num_steps - i_iter) / 3600
